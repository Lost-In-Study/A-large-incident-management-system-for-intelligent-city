...
public class MatcherSample extends com.bmwcarit.barefoot.markov.Sample {
    ...
    public MatcherSample(String id, long time, Point point) {
        this(id, time, point, Double.NaN,0);
    }
    
    public MatcherSample(String id, long time, Point point,double speed) {
        this(id, time, point, Double.NaN,speed);
    }
     ...
     * @param azimuth Azimuth of measurement sample.
     */
    public MatcherSample(String id, long time, Point point, double azimuth,double speed) {
        super(time);
        this.id = id;
        this.point = point;
